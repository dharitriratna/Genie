...
public class HotelBottomFragment extends BottomSheetDialogFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(ratna.genie1.user.genie.R.layout.fragment_hotel_bottom, container, false);
