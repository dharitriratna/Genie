...
public class GoodHomeListAdapter extends RecyclerView.Adapter<GoodHomeListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(ratna.genie1.user.genie.R.layout.vertical_list_item, parent, false);
...
// Remove the item on remove/button click
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            vertical_list_item_title = (EditText) itemView.findViewById(ratna.genie1.user.genie.R.id.vertical_list_item_title);
            vertical_list_item_subtitle=(EditText)itemView.findViewById(ratna.genie1.user.genie.R.id.vertical_list_item_subtitle);
            delete=(ImageView)itemView.findViewById(ratna.genie1.user.genie.R.id.delete);
