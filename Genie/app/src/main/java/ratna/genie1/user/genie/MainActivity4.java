...
public class MainActivity4 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,
    ...
    private void setImagePager() {
        for(int i=0;i<image.length;i++){
            TextSliderView textSliderView = new TextSliderView(MainActivity4.this);
            ...
            public void onErrorResponse(VolleyError error) {
                if (error.getMessage() == null) {
                    if (i < 3) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(MainActivity4.this, "Check your network connection.",
                                Toast.LENGTH_LONG).show();
                    }
                } else
                    Toast.makeText(MainActivity4.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
...
//creating fragment object
        ...
        switch (itemId) {
            ...
            case R.id.help_support:
                Intent help_support = new Intent(MainActivity4.this, HelpAndSupportActivity.class);
                startActivity(help_support);
                break;


            case R.id.privacy:
                Intent privacy = new Intent(MainActivity4.this, PrivacyPolicy.class);
                startActivity(privacy);
                break;

            case R.id.refund:
                Intent refund = new Intent(MainActivity4.this, RefundPolicy.class);
                startActivity(refund);
                break;

            case R.id.add_retailer:
                Intent addretailer = new Intent(MainActivity4.this,RetailerSignupActivity.class);
                startActivity(addretailer);
                break;

            case R.id.retailer_list:
                Intent retailerlists = new Intent(MainActivity4.this,RetailersListActivity.class);
                ...
                alertDialogBuilder
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                sharedpreferences = getSharedPreferences(mypreference,
                                        Context.MODE_PRIVATE);
                                Intent i = new Intent(MainActivity4.this, LogIn.class);
                                SharedPreferences.Editor editor = sharedpreferences.edit();
