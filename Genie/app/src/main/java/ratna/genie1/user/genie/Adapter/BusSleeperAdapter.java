...
import com.example.user.genie.Utils.SelectableAdapter;

import java.util.List;

public class BusSleeperAdapter extends SelectableAdapter<RecyclerView.ViewHolder> {
    ...
    public BusSleeperAdapter(Context context, List<AbstractItem> items) {
