...
public class Count extends Drawable {
    ...
    public Count(Context context) {
        ...
        paint1 = new Paint();
        paint1.setColor(ContextCompat.getColor(context.getApplicationContext(), R.color.colorAccent));//
        ...
        paint3 = new Paint();
        paint3.setColor(Color.BLACK);//WHITE
...
//	        	canvas.drawRoundRect(radius, radius, radius, radius, 10, 10, paint1);
    ...
    public static void setCounting(Context context, LayerDrawable icon, String count) {
        ...
        Drawable reuse = icon.findDrawableByLayerId(R.id.menu1A);
        ...
        icon.mutate();
        icon.setDrawableByLayerId(R.id.menu1A, badge);
    }
