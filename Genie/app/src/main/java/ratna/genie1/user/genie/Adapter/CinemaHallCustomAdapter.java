...
public class CinemaHallCustomAdapter extends RecyclerView.Adapter<CinemaHallCustomAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(ratna.genie1.user.genie.R.layout.cinemahalladapterlayout, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            cinemaTV = (TextView) itemView.findViewById(ratna.genie1.user.genie.R.id.cinemaTV);
        }
    }
