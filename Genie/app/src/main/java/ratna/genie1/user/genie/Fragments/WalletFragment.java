...
private Button continueBtn;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(ratna.genie1.user.genie.R.layout.fragment_wallet, container, false);
        phoneEd=(EditText)v.findViewById(ratna.genie1.user.genie.R.id.phoneEd);
