...
public class MovielistAdapter extends RecyclerView.Adapter<MovielistAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            imageView=(ImageView) view.findViewById(ratna.genie1.user.genie.R.id.imageview);
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(ratna.genie1.user.genie.R.layout.movielistdetaillayout, parent, false);
