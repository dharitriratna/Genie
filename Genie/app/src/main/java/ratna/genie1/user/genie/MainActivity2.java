...
import ratna.genie1.user.genie.Fragments.FragmentAddMoney;
...
*/
     ...
     /*   prepaid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RegPrefManager.getInstance(MainActivity2.this).setMobileOperator("","");
                RegPrefManager.getInstance(MainActivity2.this).setMobileCircle("","");
                RegPrefManager.getInstance(MainActivity2.this).setMobileRechargeAmount("");
                RegPrefManager.getInstance(MainActivity2.this).setPhoneNo("");
                RegPrefManager.getInstance(MainActivity2.this).setSuccessID("");
                Intent intent=(new Intent(MainActivity2.this,MobileRecharge.class));
        ...
        events.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                RegPrefManager.getInstance(MainActivity2.this).setSuccessID("");
                startActivity(new Intent(MainActivity2.this,EventManagement.class));
            }
        });
        ...
        train_booking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                RegPrefManager.getInstance(MainActivity2.this).setSuccessID("");
                startActivity(new Intent(MainActivity2.this,BookTrain.class));
            }
        });
        home_delivery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                RegPrefManager.getInstance(MainActivity2.this).setSuccessID("");
                startActivity(new Intent(MainActivity2.this, HomeDeliveryGrocery.class));
            }
        });
        ...
        broadband.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RegPrefManager.getInstance(MainActivity2.this).setLandlineOperator("","");
                RegPrefManager.getInstance(MainActivity2.this).setLandlineCircle("","");

                startActivity(new Intent(MainActivity2.this, LandLine.class));
            }
        });
        ...
        water.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                RegPrefManager.getInstance(MainActivity2.this).setWaterBoard("","");
                RegPrefManager.getInstance(MainActivity2.this).setSuccessID("");
                startActivity(new Intent(MainActivity2.this, WaterBill.class));
            }
        });
        dth.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                RegPrefManager.getInstance(MainActivity2.this).setDTHOperator("","");
                RegPrefManager.getInstance(MainActivity2.this).setMobileCircle("","");
                RegPrefManager.getInstance(MainActivity2.this).setMobileRechargeAmount("");
        ...
        moviesLinear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                RegPrefManager.getInstance(MainActivity2.this).setSuccessID("");
                startActivity(new Intent(MainActivity2.this,MovieActivity.class));
            }
        });
        flightLinear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                RegPrefManager.getInstance(MainActivity2.this).setSuccessID("");
                startActivity(new Intent(MainActivity2.this,FlightActivity.class));
            }
        });
        linearBus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                RegPrefManager.getInstance(MainActivity2.this).setSuccessID("");
                startActivity(new Intent(MainActivity2.this,BusBookingActivity.class));
            }
        });
        cabBookingLin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                RegPrefManager.getInstance(MainActivity2.this).setSuccessID("");
                RegPrefManager.getInstance(MainActivity2.this).setCabFromPlace("");
                startActivity(new Intent(MainActivity2.this,CabBookingActivity.class));
            }
        });
        rentLin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                RegPrefManager.getInstance(MainActivity2.this).setSuccessID("");
                startActivity(new Intent(MainActivity2.this,RentActivity.class));
            }
        });
        ...
        birthday_planners.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                RegPrefManager.getInstance(MainActivity2.this).setSuccessID("");
                startActivity(new Intent(MainActivity2.this,GiftsList.class));
            }
        });
        ...
        joblin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                RegPrefManager.getInstance(MainActivity2.this).setSuccessID("");
                startActivity(new Intent(MainActivity2.this,JobActivity.class));
            }
        });
        money_transfer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String id= RegPrefManager.getInstance(MainActivity2.this).getRemitterId();
                if(id!=null) {
                    startActivity(new Intent(MainActivity2.this, RemiterDetailsActivity.class));
                }else {
                    startActivity(new Intent(MainActivity2.this, RemiterRegistrationActivity.class));
                }
        ...
        datacardLn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                RegPrefManager.getInstance(MainActivity2.this).setDataCardNo("");
                RegPrefManager.getInstance(MainActivity2.this).setDataCardOperator("","");
                RegPrefManager.getInstance(MainActivity2.this).setDataCardCircle("","");

                startActivity(new Intent(MainActivity2.this,DataCardActivity.class));
            }
        });
        ...
        insuranceLn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                RegPrefManager.getInstance(MainActivity2.this).setSuccessID("");
                startActivity(new Intent(MainActivity2.this,AllInsuranseActivity.class));
            }
        });
        ...
        rawMeat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                RegPrefManager.getInstance(MainActivity2.this).setSuccessID("");
                startActivity(new Intent(MainActivity2.this,LoanPaymentActivity.class));
            }
        });
        ...
        gasLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                RegPrefManager.getInstance(MainActivity2.this).setGasBoard("","");
                RegPrefManager.getInstance(MainActivity2.this).setSuccessID("");
                startActivity(new Intent(MainActivity2.this,GasBillActivity.class));
            }
        });
        ...
        hotelLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                RegPrefManager.getInstance(MainActivity2.this).setSuccessID("");
                startActivity(new Intent(MainActivity2.this,HotelActivity.class));
            }
        });
        ...
        service_recyclerview.addOnItemTouchListener(new RecyclerTouchListener(this, service_recyclerview, new RecyclerTouchListener.ClickListener() {
            ...
            public boolean onClick(View view, int position) {
                ...
                Intent i = new Intent(MainActivity2.this, OrderGenerate.class);
...
*/
        ...
        String loggedInPhoneNumber = RegPrefManager.getInstance(this).getLoggedInPhoneNo();
        keyphone.setText(loggedInPhoneNumber);
        ...
        String image_value=RegPrefManager.getInstance(MainActivity2.this).getUpdateProfileImage();
        if(image_value!=null) {
...
//.description("Tourism")
            ...
            public void onErrorResponse(VolleyError error) {
                if (error.getMessage() == null) {
                    if (i < 3) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(MainActivity2.this, "Check your network connection.",
                                Toast.LENGTH_LONG).show();
                    }
                } else
    ...
    public boolean onCreateOptionsMenu (Menu menu){
        ...
        LayerDrawable icon = (LayerDrawable) menu_home.getIcon();
...
//creating fragment object
        ...
        switch (itemId) {
            ...
            case R.id.changepassword:
                Intent changepassword = new Intent(MainActivity2.this, ChangePassword2.class);
            ...
            case R.id.refund:
                Intent refund = new Intent(MainActivity2.this, RefundPolicy.class);
            ...
            case R.id.fse_list:
                Intent fselist = new Intent(MainActivity2.this,FSEListActivty.class);
                startActivity(fselist);
                break;
...
/*
    public boolean onPrepareOptionsMenu(Menu menu){
        ...
        String user_groups = RegPrefManager.getInstance(MainActivity2.this).getUserGroup();
