...
import ratna.genie1.user.genie.Utils.OnSeatSelected;
...
public class BusSeatFragment extends Fragment  {
    ...
    public static BusSeatFragment newInstance() {

        return new BusSeatFragment();
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View v= inflater.inflate(ratna.genie1.user.genie.R.layout.bus_seat_fragment, container, false);
        txtSeatSelected = (TextView)v.findViewById(ratna.genie1.user.genie.R.id.txt_seat_selected);
        ...
        RecyclerView recyclerView = (RecyclerView)v.findViewById(ratna.genie1.user.genie.R.id.lst_items);
