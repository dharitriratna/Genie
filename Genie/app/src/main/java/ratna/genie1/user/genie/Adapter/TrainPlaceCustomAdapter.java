...
public class TrainPlaceCustomAdapter extends RecyclerView.Adapter<TrainPlaceCustomAdapter.ViewHolder> {
    private Context context;
    private ArrayList<String> names;

    public TrainPlaceCustomAdapter(Context context, ArrayList<String> names) {
        this.names = names;
