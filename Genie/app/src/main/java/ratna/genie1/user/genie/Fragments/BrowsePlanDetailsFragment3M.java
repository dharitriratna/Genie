...
public class BrowsePlanDetailsFragment3M extends Fragment {
    ...
    public static Fragment getInstance(int position) {
        ...
        BrowsePlanDetailsFragment3M fragment = new BrowsePlanDetailsFragment3M();
