...
import ratna.genie1.user.genie.Adapter.RechargeAndBillOrderAdapter;
...
public class RechargeandBillOrdersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(ratna.genie1.user.genie.R.layout.rechargeandbillordersfragment, container, false);
        apiService =
