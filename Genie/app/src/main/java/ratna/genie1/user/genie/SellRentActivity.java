...
import ratna.genie1.user.genie.handler.AsyncTaskHandlerImage;
import ratna.genie1.user.genie.handler.AsyncTaskImageListener;
import ratna.genie1.user.genie.helper.Constants;
