...
public class MoviesGridListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            grid = inflater.inflate(R.layout.gridmovieslayout, null);
            TextView textView = (TextView) grid.findViewById(R.id.moviestv);
            TextView languagetv = (TextView) grid.findViewById(R.id.languagetv);
