...
import com.example.user.genie.Adapter.RechargeAndBillOrderAdapter;
import com.example.user.genie.Model.OrderModel;
import com.example.user.genie.Model.RechargeOrderModel;
...
public class RechargeandBillOrdersFragment extends Fragment {
    ...
    public static Fragment getInstance(int position) {
        ...
        RechargeandBillOrdersFragment fragment = new RechargeandBillOrdersFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.rechargeandbillordersfragment, container, false);
        apiService =
