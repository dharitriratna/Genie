...
import com.example.user.genie.AddMoneyActivity;
...
public class FragmentSendMoney extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View v= inflater.inflate(R.layout.activity_add_money, container, false);
        senderPhone = v.findViewById(R.id.senderPhone);
        amountTv =v.findViewById(R.id.amountTv);
        otpTv = v.findViewById(R.id.otpTv);
