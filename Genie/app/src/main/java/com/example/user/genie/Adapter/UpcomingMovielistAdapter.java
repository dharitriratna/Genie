...
public class UpcomingMovielistAdapter extends RecyclerView.Adapter<UpcomingMovielistAdapter.MyViewHolder> {
    List<Movies> horizontalList = Collections.emptyList();
    Context context;


    public UpcomingMovielistAdapter(List<Movies> horizontalList, Context context) {
