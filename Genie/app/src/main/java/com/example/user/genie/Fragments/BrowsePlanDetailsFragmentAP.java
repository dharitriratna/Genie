...
public class BrowsePlanDetailsFragmentAP extends Fragment {
    ...
    public static Fragment getInstance(int position) {
        ...
        BrowsePlanDetailsFragmentAP fragment = new BrowsePlanDetailsFragmentAP();
